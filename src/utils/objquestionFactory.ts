...
import { Media, ObjQuestionToModel } from '@/utils/questionModel'
...
export class ObjQuestionFactory extends BaseFactory<ObjQuestionToModel, ObjQuestionToModel> {
	readonly rules = {
		...
		e: { required: true, rules: [isString, isExtractedHTMLLongerThanX(0)] },
	...
	constructor () {
		super({
			examType: examTypes[0], subject: subjects[0], year: 1988, order: 1,
